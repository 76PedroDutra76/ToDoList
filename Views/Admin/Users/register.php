...
<head>
    ...
    <title>ToDoDev - Register</title>
</head>

<body>
    <main>
        <section class="w-100">
            <div class="container position-absolute top-50 start-50 rounded-3 translate-middle bg-white">
                <div class="row section01">
                    <h1 class="mt-4 text-center text-title">Cadastrar Usuário</h1>
                    <form action="<?= BASE_URL . "user/register" ?>" method="POST" class="mb-5" autocomplete="off">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label class="form-label text-normal">Nome</label>
                            <div class="input-group">
                                <div class="icons-div d-flex justify-content-center align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-person icons-style" viewBox="0 0 16 16">
                                        <path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 8c0 1-1 1-1 1H3s-1 0-1-1 1-4 6-4 6 3 6 4Zm-1-.004c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h10Z" />
                                    </svg>
                                </div>
                                <input type="text" class="form-control text-normal text-dark" name="nome" required>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-center mt-3">
                            <p class="mb-1 mt-2 text-normal">Já Possui uma conta?</p>
                            <a href="<?= BASE_URL . "user/" ?>" class="mb-0 a-link">Fazer Login</a>
                        </div>
                    </form>
                </div>
        </section>
